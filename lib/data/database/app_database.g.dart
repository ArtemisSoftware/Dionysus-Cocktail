    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `DrinkEntity` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `description` TEXT NOT NULL, `urlThumbnail` TEXT NOT NULL, `urlImage` TEXT NOT NULL, `modifiedAt` TEXT NOT NULL, PRIMARY KEY (`id`))');
